...
class Entiti(Object):
    ...
    def shot(self, direction, list):
        ...
        if duration >= 0.7:
            if direction == 'up':      list.append(Bullet(self.rect.centerx, self.rect.centery, 10, 10, "up", self.comand, self.damage, self.speed*2.5))
            elif direction == 'down':  list.append(Bullet(self.rect.centerx, self.rect.centery, 10, 10, "down", self.comand, self.damage, self.speed*2.5))
            elif direction == 'left':  list.append(Bullet(self.rect.centerx, self.rect.centery, 10, 10, "left", self.comand, self.damage, self.speed*2.5))
            elif direction == 'right': list.append(Bullet(self.rect.centerx, self.rect.centery, 10, 10, "right", self.comand, self.damage, self.speed*2.5))
            self.start_time = time.time()
            return list
